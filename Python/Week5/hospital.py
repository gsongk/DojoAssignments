...
# • Admit: add a patient to the list of patients. Assign the patient a bed number. If the 
...
# • Discharge: look up and remove a patient from the list of patients. Change bed number 
# for that patient back to none.
# This is a challenging assignment. Ask yourself what input each method requires and what 
